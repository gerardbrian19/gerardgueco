...
export default class Second_Article extends Component {
    constructor(props) {
        super(props)
        this.state = {
            menuOpen: false
                                ...
                                <Grid.Row>
                                    <Grid.Column computer={10} tablet={16} mobile={16}>
                                        {Object.keys(this.props).map((data, i) => {
                                            return this.props[data].articlenum == "2" ?
                                            <div key={i}>
                                                <TitleAuthorHeader
                                                ...
                                                <div className="text-content">
                                                    ...
                                                    Object.getOwnPropertyNames(subData).map((data, l) => 
                                                    data == "p" ?
                                                    <div key={k}>
                                                        <ArticleParagraph
                                                    ...
                                                    : 
                                                 data == "inl_img" ? subData.inl_img.map((sData, a) => (
                                                 <div key={k}><InlineImage inl_img_src={sData.img} inl_cap={sData.caption} /></div>
                                                 )) :  null
                                                    )
                                                    )
                                                    : null}
